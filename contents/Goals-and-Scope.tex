...
We will study the possibilities of the current hardware in WebLab-Deusto (Romie, the robot) and the
needed changes will be performed to adapt it to the needs of the project.
...
the game in a production environment along with the rest of the experiments. This will provide the
game with a simple interface for the communication with the experiment server and with the robot. It
will also be in charge of managing user queues and user authentication.
