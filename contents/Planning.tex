...
\begin{table}[h]
	...
	\begin{tabular}{ccccccc}
		\toprule
		\textbf{Task} & \emph{Dependencies} & \emph{Resource} & \emph{Days} & \emph{Work} & \emph{Start date} & \emph{Ending date}\\
		\midrule
...
\begin{figure}
	\centering
	\includegraphics[width=\textheight, angle=-90]{fig/precedence}
