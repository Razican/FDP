...
\begin{figure}
	\centering
	\includegraphics[trim=0in 0in 26.75in 0in, clip, angle=90]{fig/precedence}
	\caption[Precedence diagram of the project.]{Precedence diagram of the project. Continues in
	next pages.}\label{fig:precedence}
\end{figure}
\clearpage
\begin{center}
	\includegraphics[trim=8.13in 0in 18.6in 0in, clip, angle=90]{fig/precedence}\clearpage
	\includegraphics[trim=16.25in 0in 9.5in 0in, clip, angle=90]{fig/precedence}\clearpage
	\includegraphics[trim=25.37in 0in 0in 0in, clip, angle=90, width=0.87\textwidth]{fig/precedence}\clearpage
\end{center}
