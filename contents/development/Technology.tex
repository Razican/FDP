...
supported by all web browsers. Nevertheless, since we wanted to fasten the development,
...
As we can see in algorithm~\ref{alg:weblab_server_api}, WebLab has some built-in methods for the
